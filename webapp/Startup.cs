...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<IWeatherForecastService>(InitializeCosmosClientInstanceAsync(Configuration.GetSection("CosmosDb")).GetAwaiter().GetResult());
    }
    // </ConfigureServices> 
    ...
    /// </summary>
    /// <returns></returns>
    private static async Task<WeatherForecastService> InitializeCosmosClientInstanceAsync(IConfigurationSection configurationSection)
    {
